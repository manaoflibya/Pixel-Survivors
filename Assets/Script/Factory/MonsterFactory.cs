...
{
    public override GameObject AddObject(OBJECT_TYPE myType, Vector3 spawnPos, GameObject target, System.Action<OBJECT_TYPE,int,GameObject> monsterAction , float health, float damage, float speed, Vector3 size)
    {
